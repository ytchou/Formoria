...
export const metadata: Metadata = {
  title: '常見問題',
  description:
    '關於 Formoria 台灣品牌目錄的常見問題解答 — 了解什麼是台灣製造、如何提交品牌、審核流程與品牌認領方式。',
...
const FAQ_ITEMS: FaqItem[] = [
  {
    question: '什麼是 Formoria？',
    answer:
      'Formoria 是一個開放原始碼的台灣品牌目錄，致力於讓更多人認識與支持台灣製造的優質品牌。無論你是想探索本土品牌的消費者，還是希望被更多人看見的品牌經營者，Formoria 都是你的起點。',
  },
  {
    question: '「MIT」是什麼意思？',
    answer:
      '「MIT」代表 Made in Taiwan，即台灣製造。Formoria 收錄的品牌，主要生產製造在台灣，包含在台灣設計、生產或創立的品牌。我們看重的不只是產地標籤，更是每個品牌背後的工藝精神與品牌故事。',
  },
  {
    question: '如何提交品牌到 Formoria？',
    answer:
      '任何人都可以透過我們的提交表單提交品牌資料。請前往「提交品牌」頁面，填寫品牌基本資訊、官方網站、社群連結等內容，送出後由 Formoria 團隊進行審核。我們不收取任何費用，審核以品質與真實性為唯一標準。',
  },
  {
    question: '品牌審核需要多久時間？',
    answer:
  ...
  },
  {
    ...
    answer:
      'Formoria 採眾包方式收集品牌資料，並由管理團隊在審核時進行初步核實。如果你發現任何品牌資訊有誤或已過期，歡迎透過聯絡方式告知我們，我們會盡快處理。',
  },
  {
    question: '如何聯繫 Formoria 團隊？',
    answer:
