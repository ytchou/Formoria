  ...
  return (
    <>
      <button
        ...
        disabled={disabled}
        className={cn(
          'flex min-h-24 w-full items-center justify-center gap-2 rounded-lg border border-dashed border-border bg-muted px-4 py-4 type-metadata transition-colors hover:border-accent hover:text-accent disabled:cursor-not-allowed disabled:opacity-60',
          FOCUS_RING,
          className
        )}
      >
