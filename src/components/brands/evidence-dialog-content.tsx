...
export function EvidenceDialogContent({
  brandId,
  brandSlug,
}: EvidenceDialogContentProps) {
    ...
    <DialogContent size="form">
      ...
      {state.success ? (
        ...
        <DialogForm action={action}>
          ...
          {photoPath && (
            <input type="hidden" name="photoPaths" value={photoPath} />
          )}
            ...
            <div className="space-y-2">
              ...
              >
                <option value="product_label">
                  {t("sourceTypes.product_label")}
                </option>
                <option value="packaging">{t("sourceTypes.packaging")}</option>
                <option value="official_site">
                  {t("sourceTypes.official_site")}
                </option>
