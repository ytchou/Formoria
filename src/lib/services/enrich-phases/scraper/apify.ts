...
export const APIFY_SERP_ENDPOINT =
  'https://api.apify.com/v2/acts/apify~google-search-scraper/run-sync-get-dataset-items'
export const APIFY_IMAGE_SEARCH_ENDPOINT =
...
export const BATCH_SEARCH_TIMEOUT_MS = 240_000

export type ApifySerpEntry = {
  searchQuery?: { term?: string; url?: string }
  organicResults?: Array<{ url?: string; title?: string; description?: string }>
  error?: string
}

export type ApifyImageSearchResult = {
...
export function isApifySerpEntry(value: unknown): value is ApifySerpEntry {
