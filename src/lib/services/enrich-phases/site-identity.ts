...
function applyVerdict(
  ...
  const revokedText = revokeText(quarantine, quarantine.subjectUrl, quarantine.subjectKind)
  filterRevokedImages(quarantine.linksResult, quarantine.subjectUrl, quarantine.subjectKind)
  return {
    phaseResult: buildPhaseResult('site_identity', 'succeeded', [...removedColumns, ...newlyCleared, ...revokedText], 0, undefined, decision.reason),
    removedColumns,
    clearedFields,
