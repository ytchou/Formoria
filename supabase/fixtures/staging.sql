...
with fixture(id, name, slug, category, city, purchase_website) as (
  values
    ...
    ('51000000-0000-4000-8000-000000000027'::uuid, '一屋 1woof', '1woof', 'kids-pets', null, null),
    ('51000000-0000-4000-8000-000000000028'::uuid, '2Angels', '2angels', 'kids-pets', null, 'https://2angelsbaby.com'),
    ('51000000-0000-4000-8000-000000000029'::uuid, '安閣家 ANGLE WAVE', 'angle-wave', 'kids-pets', 'changhua', 'https://www.anglewave.com'),
