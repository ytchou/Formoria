...
-- One-shot data migration (DEV-1322) — already applied remotely, so push skips it.

begin;

-- The PR's 20260804100000 filename is already occupied remotely by the
-- external_call_audit migration. Apply the intended data migration under this
-- unique operational version instead of silently treating it as applied.
