-- Reverts 20260924120000_brand_quality_hero_storage_path.sql: restores the
-- production definition captured 2026-09-24 (hero counted from hero_image_url only).
