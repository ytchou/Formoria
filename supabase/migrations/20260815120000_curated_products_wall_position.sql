...
comment on column public.curated_products.wall_position is
  'Homepage wall ordering, nulls last. Independent of product_position (brand-page scoped) and curated_product_selections.position (trail scoped). See docs/decisions/2026-08-15-homepage-wall-ordering-and-eligibility.md';
