...
UPDATE brands SET
  founder = '{"name": "林雅芳", "title": "創辦人", "avatar_url": "https://placeholder.formoria.com/shan-wu-tea-house/founder.jpg", "quote": "茶是一種生活態度，不只是飲品。"}',
...
UPDATE brands SET
  founder = '{"name": "陳柏宇", "title": "陶藝師", "avatar_url": "https://placeholder.formoria.com/claylight-studio/founder.jpg", "quote": "土地給我們的，我們用雙手還給生活。"}',
...
UPDATE brands SET
  founder = '{"name": "張心怡", "title": "設計總監", "avatar_url": "https://placeholder.formoria.com/woven-words/founder.jpg", "quote": "每一條線都是一個故事。"}',
...
UPDATE brands SET
  founder = '{"name": "王建志", "title": "創辦人", "avatar_url": "https://placeholder.formoria.com/island-season/founder.jpg", "quote": "好的食物不需要過多加工。"}',
...
UPDATE brands SET
  founder = '{"name": "蘇雨婷", "title": "品牌創辦人", "avatar_url": "https://placeholder.formoria.com/skin-verse/founder.jpg", "quote": "肌膚也需要回歸自然。"}',
