...
check_ops_agent_vars() {
  ...
  for var in SLACK_BOT_TOKEN SLACK_SIGNING_SECRET OPS_AGENT OPS_AGENT_OPERATORS OPS_AGENT_DAILY_CAP OPS_AGENT_GITHUB_TOKEN OPS_ROUTINE_TOKEN OPS_ROUTINE_ID; do
