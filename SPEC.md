...
sections remain governed by the registry and spend coverage but are omitted
from the Personal OS inventory payload. The four visible sections preserve
registry order; Linear and GitHub remain inventory-only and are not executive
health probes.
