# Formoria Brand Voice — Social Content

Project-specific overlay on the base Taiwan-Mandarin social register (`~/.claude/skills/shared/zh-tw/social-voice.md`). This file is consumed by `/social-content` and `/marketing produce` to ensure consistent tone across all Formoria social output.

## Brand Tone

Warm, understated confidence. A curator sharing discoveries — not a brand selling.
...
- Ceramics/craft: #台灣陶藝 #台灣工藝
- Food/beverage: #台灣好食 #台灣茶
- Lifestyle/home: #台灣設計 #台灣生活
- Fashion/textile: #台灣服飾 #台灣織品

**Frequency:**
- Threads: 2-4 tags (platform culture favors minimal tags)
- Instagram: 5-8 tags (discovery-driven platform)

**Style:** No ironic or meme hashtags. Tags serve discovery, not personality. The caption handles the voice.
